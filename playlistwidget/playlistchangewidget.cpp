    ...
    , _userToneChange(nullptr)
{
    ...
    connect(ui->userToneWidget, &FM2Widget::changed, this, &PlaylistChangeWidget::userToneChanged);
}
...
{
    _app->undoStack().push(new EditFM2SettingsCommand(_app->window(), _userToneChange->userTone(), ui->userToneWidget->settings()));
}
