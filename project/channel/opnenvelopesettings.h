#ifndef OPNENVELOPESETTINGS_H
#define OPNENVELOPESETTINGS_H

#include "settings.h"

class OPNEnvelopeSettings : public Settings
{
    public:
        OPNEnvelopeSettings();
        ...
        bool operator==(const OPNEnvelopeSettings& other) const;
