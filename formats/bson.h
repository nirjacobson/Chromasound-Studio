...
class BSON
{
    public:
        ...
        static QByteArray encodeSettings(const Settings* settings);
    ...
    private:
        ...
        static void fromTrackPitchChange(bson_t* dst, const Track::PitchChange* const change);
        static Track::PitchChange toTrackPitchChange(bson_iter_t& b);
